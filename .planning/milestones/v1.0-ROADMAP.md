...
**Phases:** 1–5  
**Total plans (indexed):** 1 formal plan (Phase 1); phases 2–5 shipped without separate PLAN files.

_Full roadmap text as of milestone close-out. For the living roadmap, see `.planning/ROADMAP.md`._
