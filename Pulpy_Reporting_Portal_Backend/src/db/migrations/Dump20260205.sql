...
) ENGINE=InnoDB AUTO_INCREMENT=378026 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `conversions` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `conversion_uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT (uuid()),
  `click_uuid` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `offer_id` int NOT NULL,
  `publisher_id` int NOT NULL,
  `tenant_id` int DEFAULT NULL,
  `publisher_offer_id` int DEFAULT NULL,
  `rcid` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `status` enum('pending','approved','rejected','rejected_cap') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'pending',
...
) ENGINE=InnoDB AUTO_INCREMENT=30084 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `offers` (
  ...
  `capping_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'none' COMMENT 'Capping type: none, daily, weekly, or monthly',
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Audit trail for all subscription and trial changes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-02-05 14:39:35
