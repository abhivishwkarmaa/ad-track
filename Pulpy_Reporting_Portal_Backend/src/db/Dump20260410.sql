...
--
-- Host: 94.136.187.247    Database: track_myads
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=24716 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `clicks` (
  ...
  `x_forwarded_for` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `user_agent` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `referrer` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `authorization_token` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `tid` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  KEY `idx_clicks_tenant_created_offer_pub` (`tenant_id`,`created_at`,`offer_id`,`publisher_id`),
  KEY `idx_clicks_tenant_created_offer_pub_ip` (`tenant_id`,`created_at`,`offer_id`,`publisher_id`,`ip`),
...
) ENGINE=InnoDB AUTO_INCREMENT=13185249 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `conversions` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `conversion_uuid` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `click_uuid` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `offer_id` int NOT NULL,
  `publisher_id` int NOT NULL,
  `tenant_id` int DEFAULT NULL,
  `publisher_offer_id` int DEFAULT NULL,
  ...
  KEY `idx_conversions_tenant_created_offer_pub_status` (`tenant_id`,`created_at`,`offer_id`,`publisher_id`,`status`),
...
) ENGINE=InnoDB AUTO_INCREMENT=83998 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1898308 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `daily_reporting_rollup`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `daily_reporting_rollup` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `tenant_id` int NOT NULL,
  `stat_date` date NOT NULL COMMENT 'IST calendar date (computed in Node.js)',
  `publisher_id` int NOT NULL,
...
CREATE TABLE `offers` (
  ...
  `legacy_capping_mix` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'none',
  ...
  `capping_type` enum('budget','conversion') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `capping_duration` enum('daily','weekly','monthly') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `capping_action` enum('stop','reject','fallback') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'stop',
  `fallback_type` enum('offer','custom') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `country_action` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Country targeting action: ALLOW or BLOCK',
  `country_list` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT 'List of countries to allow or block (comma separated)',
  `billing_flow` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Offer billing flow (free-form string)',
  `billing_type` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Offer billing type (free-form string)',
  PRIMARY KEY (`id`),
...
CREATE TABLE `subscription_history` (
  `id` int NOT NULL AUTO_INCREMENT,
  `tenant_id` int NOT NULL,
  `action` enum('TRIAL_STARTED','TRIAL_EXTENDED','SUBSCRIPTION_ACTIVATED','SUBSCRIPTION_EXTENDED','SUBSCRIPTION_EXPIRED','TENANT_SUSPENDED','TENANT_UNSUSPENDED','TRIAL_RESET') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `previous_state` enum('TRIAL','ACTIVE','EXPIRED','SUSPENDED') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `new_state` enum('TRIAL','ACTIVE','EXPIRED','SUSPENDED') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT 'Additional notes about the action',
...
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Audit trail for all subscription and trial changes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tenants` (
  ...
  `status` enum('TRIAL','ACTIVE','EXPIRED','SUSPENDED') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'TRIAL' COMMENT 'Tenant subscription state',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  `subscription_plan` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Subscription plan identifier (e.g., basic, pro, enterprise)',
  `billing_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Billing contact email',
  PRIMARY KEY (`id`),
...
CREATE TABLE `test_postback_sessions` (
  ...
  `test_token` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tracking_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `received_tid` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('pending','fired','expired') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
...
-- Dump completed on 2026-04-10 17:49:19
