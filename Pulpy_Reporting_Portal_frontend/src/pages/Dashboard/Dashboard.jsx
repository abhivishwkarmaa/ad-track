...
function Dashboard() {
    ...
    useEffect(() => {
        ...
        fetchDashboardCards();
        fetchTopOffers();
        fetchPerformance(); // ✅ ADDED: Fetch performance chart data
        fetchTopAffiliates();
        fetchTopCountries();
        fetchSummaryData();
        fetchDetailedData();
                                ...
                                <AreaChart data={performanceData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                    <defs>
                                        <linearGradient id="colorClicks" x1="0" y1="0" x2="0" y2="1">
                                            <stop offset="5%" stopColor="#1BB6B8" stopOpacity={0.2} />
                                            <stop offset="95%" stopColor="#1BB6B8" stopOpacity={0} />
                                        </linearGradient>
                                        <linearGradient id="colorConversions" x1="0" y1="0" x2="0" y2="1">
                                            <stop offset="5%" stopColor="#E9A248" stopOpacity={0.2} />
                                            <stop offset="95%" stopColor="#E9A248" stopOpacity={0} />
                                        </linearGradient>
                                    </defs>
